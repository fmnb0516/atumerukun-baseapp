...
module.exports = (installer, context) => {
	installer.get('/webscraping/console', (req, res) => {
	...
	installer.get('/webscraping/list', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.allWebscraping()
			.then(successHandler, errorHandler);
	});
	
	installer.get('/webscraping/:id', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.getWebscraping(req.params.id)
			.then(successHandler, errorHandler);
	});
	
	installer.put('/webscraping/:id', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.updateWebscraping(req.params.id, req.body)
			.then(successHandler, errorHandler);
	});
	
	installer.delete('/webscraping/:id', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.removeWebscraping(req.params.id)
			.then(successHandler, errorHandler);
	});
	
	installer.post('/webscraping/new', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.createWebscraping(req.body)
			.then(successHandler, errorHandler);
	});
	
	installer.get('/pageresult/list', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.allPageResult(req.query.web_scraping_id, req.query.offset, req.query.limit)
			.then(successHandler, errorHandler);
	});
	
	installer.get('/pageresult/:id', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
	...
	installer.delete('/pageresult/:id', (req, res) => {
		const successHandler = createSuccessHandler(req, res);
		const errorHandler = createErrorHandler(req, res);
		
		context.repo.removePageResult(req.params.id)
			.then(successHandler, errorHandler);
	});
